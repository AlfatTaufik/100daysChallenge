...
{
    public partial class Mutation_Form : Form
    {
        private readonly string userEmail;

        public Mutation_Form(string userEmail)
        {
            InitializeComponent();
        ...
        private void Mutation_Form_Load(object sender, EventArgs e)
        {
        }
